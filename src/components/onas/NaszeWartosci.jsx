  ...
  return (
    <section className="px-4 pb-16">
      <div className="mx-auto flex max-w-4xl flex-col items-center">
        <h2 className="mb-8 text-center font-headings text-4xl text-text-primary md:text-5xl">
          Nasze wartości
        </h2>
        <div className="grid w-full grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {values.map((value) => (
            ...
            >
              <span className="material-symbols-outlined text-logo !text-5xl">
                {value.icon}
              </span>
              <h4 className="mt-4 font-headings text-xl text-text-primary">
                {value.title}
              </h4>
